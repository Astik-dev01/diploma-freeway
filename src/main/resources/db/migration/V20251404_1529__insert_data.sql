...
('Учителько', 'Анна', 'FEMALE',
 '$2a$10$DaMPIsKYoU/6uPnignPxN.xl8Lkmd7INBcduIYGArK/82nLotVcO6', -- password: "admin"
 'seri.ken.astai@gmail.com', true, true, false, CURRENT_TIMESTAMP, false, false, '+996700000003'),
...
-- TEACHER 2
('Иванова', 'Мария', 'FEMALE',
 '$2a$10$DaMPIsKYoU/6uPnignPxN.xl8Lkmd7INBcduIYGArK/82nLotVcO6',
 'serikovastan@gmail.com', true, true, false, CURRENT_TIMESTAMP, false, false, '+996700000005');
...
VALUES ('Факультет информационных технологий', false),
